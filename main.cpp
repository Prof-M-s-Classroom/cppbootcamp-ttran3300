...
// Step 2: Function to modify robot (pass by value)
    void modifyRobotByValue(Robot r) {
        r.setName("Modified Robot");
        r.setModel("Y100");
        r.setBatteryLife(80);
        cout<<"Inside function using pass by value: "<<r.getName()<<" "<<r.getModel()<<" "<<r.getBatteryLife()<<endl;
    }
...
// Step 3: Function to modify robot (pass by reference)
    void modifyRobotByReference(Robot& r) {
        ...
        r.setModel("Y100");
        r.setBatteryLife(80);
        cout<<"Inside function using pass by reference: "<<r.getName()<<" "<<r.getModel()<<" "<<r.getBatteryLife()<<endl;
    }
...
int main() {
    ...
    Robot myRobot("Tammy Robot", "Model Y", 100);
